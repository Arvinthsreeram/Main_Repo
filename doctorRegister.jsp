...
<section id="Register-doctor">
    <div class="register-container">
      ...
      <p style="diplay:inline-block;">
        ...
        <input type="text" placeholder="Specialist" class="form-control" id="specialist" name="specialist" required><br>
        <input type="password" placeholder="Password" class="form-control" id="password" name="password" required><br>
         ...
         <input type="text" placeholder="Address" class="form-cotrol" id="address" name="address" required><br><br>
