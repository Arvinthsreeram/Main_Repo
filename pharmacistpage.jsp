...
<header>
  ...
  <h1 style="text-align:center;font-family:Times new romen;">Welcome Pharmacist&#128512;!!!</h1><br><br>
  
 <section class="image">
  <div class="mine">
      <a href="addpatient"><img src="https://img.freepik.com/free-photo/happy-senior-man-handshaking-with-female-doctor-while-talking-lobby-clinic_637285-460.jpg?size=626&ext=jpg&ga=GA1.1.816356618.1707192843&semt=sph" alt="patient"></a>
      <h2>ADD PATIENT</h2>
  </div>
  
   <div class="mine">
      <a href="addappointment"><img src="https://img.freepik.com/free-photo/happy-woman-talking-receptionist-while-arriving-spa_637285-9455.jpg?size=626&ext=jpg&ga=GA1.1.816356618.1707192843&semt=ais" alt="appointment"></a>
      <h2>ADD APPOINTMENT</h2>
      </div>
      
   <div class="mine">
      <a href="addmedicine"><img src="https://img.freepik.com/premium-photo/medicine-bottle-colorful-pills_785361-341.jpg?size=626&ext=jpg&ga=GA1.1.816356618.1707192843&semt=sph" alt="medicine" style="width:40%"></a>
      <h2>ADD MEDICINE</h2>
      </div>
      
    <div class="mine">
      <a href="viewmedicine"><img src="https://img.freepik.com/premium-photo/colorful-pills-spilling-out-pill-bottle-black-reflective-background_934652-5765.jpg?size=626&ext=jpg&ga=GA1.1.816356618.1707192843&semt=sph" alt="medicine" style="width:40%"></a>
      <h2>UPDATE / DELETE MEDICINE</h2>
      </div>
  </section>
